...
require(['jquery', 'underscore', 'splunkjs/mvc', 'autopause_util', 'splunkjs/mvc/simplexml/ready!'],
    ...
    function make_bunit_token(value) {            
        ...
        if (value !== null && value !== '') {
            bunit = '(All_Traffic.src_bunit="' + value + '" OR All_Traffic.dest_bunit="' + value + '" OR All_Traffic.user_bunit="' + value + '")';
        }
    ...
    function make_category_token(value) {            
        ...
        // update tokens if value is positive
        if (value !== null && value !== '') {
            category = '(All_Traffic.src_category="' + value + '" OR All_Traffic.dest_category="' + value + '" OR All_Traffic.user_category="' + value + '")';
        }
