...
logger = setup_logger('transitioners_rest_handler', level=logging.INFO, format=SHORT_FORMAT)
          ...
          for stanza, settings in authorizeDict.items():
              ...
              if transitionMatch:
                  ...
                  # Add the item if it is disabled
                      ...
                      if not util.normalizeBoolean(settings[Transitioners.PARAM_DISABLED]):
                          transitions.append(transitionMatch.group(1))
